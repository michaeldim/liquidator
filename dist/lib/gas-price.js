...
var lastPrice = process.env.INITIAL_GAS_PRICE;
...
function updateGasPrice() {
    return __awaiter(this, void 0, void 0, function () {
        var response, error_1, fast, multiplier, totalWei;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, getGasPrices()];
                case 1:
                    response = _a.sent();
                    return [3 /*break*/, 3];
                case 2:
                ...
                case 3:
                    ...
                    multiplier = Number(process.env.GAS_PRICE_MULTIPLIER);
                    if (Number.isNaN(multiplier)) {
                        throw new Error('GAS_PRICE_MULTIPLIER not specified');
                    }
                    totalWei = "" + Math.round(Number(fast) * multiplier * 100000000);
                    logger_1.default.info({
                        at: 'updateGasPrice',
